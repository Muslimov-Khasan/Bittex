...
const Header = () => {
  ...
  const fetchDataAll = async () => {
    ...
    const response = await fetch("https://vaziat.uz/api/v1/admin/all", {
      method: "GET",
      headers: {
  ...
  const handleFormSubmit = async (event) => {
    ...
    try {
      const storedToken = localStorage.getItem("authToken");
      const response = await fetch(`https://vaziat.uz/api/v1/admin/create`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${storedToken}`,
  ...
  const handleDeleteConfirmed = async () => {
    try {
      ...
      const response = await fetch(
        `https://vaziat.uz/api/v1/admin/${adminToDelete}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${storedToken}`,
  ...
  const handleModify = async () => {
    ...
    try {
      const storedToken = localStorage.getItem("authToken");
      const response = await fetch(
        `https://vaziat.uz/api/v1/admin/${showButtons}`,
        {
          method: "GET",
          headers: {
            Authorization: `Bearer ${storedToken}`,
  ...
  const handleEditFormSubmit = async (event) => {
    ...
    try {
      const storedToken = localStorage.getItem("authToken");
      const response = await fetch(`https://vaziat.uz/api/v1/admin/update`, {
        method: "PUT",
        headers: {
          Authorization: `Bearer ${storedToken}`,
          "Content-Type": "application/json",
