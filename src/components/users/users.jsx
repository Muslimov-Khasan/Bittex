...
const Users = () => {
  ...
  const fetchDataUsers = async () => {
    ...
    const response = await fetch("https://vaziat.uz/api/v1/users/all", {
      method: "GET",
      headers: {
  ...
  const blockUser = async (userId) => {
    ...
    let a = { block: userId }
    let res = await fetch(
      `https://vaziat.uz/api/v1/users/change-block-status/${userId}`,
      {
        method: "PUT",
        headers: {
          Authorization: `Bearer ${storedToken}`,
    ...
    localStorage.setItem(`blockedUser_${userId}`, userId);
  ...
  const unblockUser = async (userId) => {
    const storedToken = localStorage.getItem("authToken");
    fetch(`https://vaziat.uz/api/v1/users/change-block-status/${userId}`, {
      method: "PUT",
      headers: {
        Authorization: `Bearer ${storedToken}`,
        "Content-Type": "application/json",
